...
java.exe -Dlogback.configurationFile=..\conf\logback-download.xml -cp %RINGO% no.sr.ringo.standalone.RingoClientMain --username %1 --password %2 --inboxPath %3 --download --address %AP_ADDRESS%