...
import no.sr.ringo.persistence.test.InMemoryDataSourceHelper;
 ...
 *         Time: 12:04
 */
public class ServerTestDataSourceModule extends AbstractModule {

    public static final Logger log = LoggerFactory.getLogger(ServerTestDataSourceModule.class);
    @Override
