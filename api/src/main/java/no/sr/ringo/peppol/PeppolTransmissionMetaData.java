...
public class PeppolTransmissionMetaData implements Serializable {
    ...
    public void setRecipientId(ParticipantIdentifier recipientId) {
        if (recipientId == null) {
            throw new IllegalArgumentException("value required for setRecipientId()");
        }
    ...
    public void setSenderId(ParticipantIdentifier senderId) {
        if (senderId == null) {
            throw new IllegalArgumentException("value required for setSenderId()");
        }
    ...
    public void setDocumentTypeIdentifier(DocumentTypeIdentifier documentTypeIdentifier) {
        if (documentTypeIdentifier == null) {
            throw new IllegalArgumentException("value required for setDocumentTypeIdentifier()");
        }
