...
import no.sr.ringo.guice.GuiceServiceLoader;
...
class PluginFactoryImpl implements PluginFactory {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(PluginFactoryImpl.class);
    ...
    public <T> T newInstance(Class<T> cls) {
        ...
        if (instances.size() != 1) {
            for (T instance : instances) {
                LOGGER.error("{} implementation {} ", cls.getClass(), instance.getClass());
            }
