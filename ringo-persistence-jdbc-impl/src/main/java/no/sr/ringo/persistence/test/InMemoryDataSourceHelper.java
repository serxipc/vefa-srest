...
package no.sr.ringo.persistence.test;
...
public class InMemoryDataSourceHelper {
    ...
    public static final Logger log = LoggerFactory.getLogger(no.sr.ringo.persistence.jdbc.util.InMemoryDatabaseHelper.class);
    ...
    private static void createDatabaseSchema(DataSource ds, String sqlScriptResource) {
        ...
        try (InputStream resourceAsStream = no.sr.ringo.persistence.jdbc.util.InMemoryDatabaseHelper.class.getClassLoader().getResourceAsStream(sqlScriptResource)){
