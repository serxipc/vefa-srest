...
/** To of TEST database : Create a new database called ringo_test and run this script */
/** To of PROD database : Create a new database called ringo and run this script */
...
CREATE TABLE `message` (
  ...
  `remote_host` VARCHAR (256) DEFAULT NULL comment 'URI of receiving host (for outbound only)',
